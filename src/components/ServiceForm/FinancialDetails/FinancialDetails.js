...
const createFinancialDetails = () => function FinancialDetails({
  service_items_price = "",
  service_price = "",
  discount_price = "",
  observations = "",
  ...
  return (
    <div className="flex-col w-full">
      <div className="flex w-full">
        ...
        <div className="flex-col w-1/2">
          <div className="flex-col">
            ...
            <TextField
              onChange={(e) => updateServiceValuesOnChange("odometer_reading")(
                e.target.value,
              )}
              onBlur={(e) => updateValueOnBlur({
      ...
      <div className="flex mt-6">
        <TextField
          onChange={(e) => updateServiceValuesOnChange("observations")(e.target.value)}
...
function LabelAndPrice({
  label, price, onChange = () => {}, ...props
}) {
  return (
